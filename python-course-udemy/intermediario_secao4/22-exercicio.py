...
considerando o segundo número como duplicação.
Retorne a duplicação considerada
Requisitos:
        A ordem do número duplicado é considerada 
        a partir da segunda ocorrência do número,
        ou seja, o número duplicado em si.
        Exemplo:
            [1, 2, 3, 3, 2, 1] -> 1, 2 e 3 são duplicados (retorne 3, que é o primeiro duplicado)
